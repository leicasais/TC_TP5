...
\begin{figure}[h!]
    ...
    \end{circuitikz}
    \vspace{0.2cm}
    \caption{Modelo equivalente tipo $\Pi$ propuesto para el análisis del Cuadripolo 1.}
    ...
    \end{circuitikz}
    \vspace{0.2cm}
    \caption{Modelo equivalente tipo $T$ propuesto para el análisis del Cuadripolo 2.}
